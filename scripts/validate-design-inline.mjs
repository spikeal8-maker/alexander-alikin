...
const runtimeComponentDirs = [
  path.join(ROOT, "src", "components", "v3"),
  path.join(ROOT, "src", "components", "v2", "journal"),
];
...
for (const file of [
  ...runtimeComponentDirs.flatMap((directory) => walk(directory)),
  ...controlRoutes,
]) {
